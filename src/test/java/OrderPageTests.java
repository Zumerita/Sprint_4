...
public class OrderPageTests {
    ...
    public static Object[][] setDataForOrder() {
        return new Object[][]{
                {"Рита", "Демидова", "Москва, ул. Дорожная, д. 12, кв. 34", "Сокол", "81234567890", "03.06.2023", "четверо суток", "чёрный жемчуг", "Сюда!"},
                {"Петр ", "Петров", "Москва, ул. Скобелевская, д. 26, кв. 1", "Улица Скобелевская", "89876543210", "21.05.2023", "трое суток", "серая безысходность", "Привезите в первой половине дня"},
        };
    }
